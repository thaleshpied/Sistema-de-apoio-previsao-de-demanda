...
ALTER TABLE `fornecedores` ADD PRIMARY KEY (`idFornecedor`), ADD UNIQUE KEY `idFornecedor_UNIQUE` (`idFornecedor`)

ALTER TABLE `fornecedores`
  MODIFY `idFornecedor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61672;
